...
import (
	"github.com/Runscope/gokogiri/html"
	"github.com/Runscope/gokogiri/xml"
)
...
found in the github.com/Runscope/gokogiri/xml package. The xml.StrictParsingOption is conveniently provided for standards-compliant
behaviour.
*/
